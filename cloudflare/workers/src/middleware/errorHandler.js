...
export const safeFail = (error, message) => {
...
export const safeQuery = async (queryFn, emptyResult = []) => {
    try {
...
export const safeExecute = async (executeFn) => {
    try {
        await executeFn();
        return { success: true };
    }
...
export const safelyGetJson = async (response) => {
    try {
